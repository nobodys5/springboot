package com.kyp.springboot.provider;
...
public class JwtProvider {
    ...
    @Value("${jwt.secret}")
    private String secretKey = "qwerqwerqwerqwerqwerqwer1234qwerqwerqwerqwerqwerqwer1234qwerqwerqwerqwerqwerqwer1234";
    ...
    // 3. 외부 데이터 관리 도구를 사용
    // - 자체 서버가 아닌 타 서버에 등록된 Valut 도구를 사용하여 비밀키 관리
    ...
    public String create(String name) {
        ...
        // 비밀키 생성 
        // String secretKey = "qwerqwerqwerqwerqwerqwer1234qwerqwerqwerqwerqwerqwer1234qwerqwerqwerqwerqwerqwer1234";
    ...
    public String validate(String jwt) {
        ...
        // jwt 검증 결과로 반환되는 paypload가 저장될 변수
        Claims claims = null;
